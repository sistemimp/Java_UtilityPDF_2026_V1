...
public final class RisoComcolorGd9630OptimizeTab {
    private RisoComcolorGd9630OptimizeTab() {
    }
    ...
    public static JPanel create(App controller, JFrame parent) {
        ...
        JButton optimizeButton = new JButton("Ottimizza per Riso ComColor GD9630");

        browseInputButton.addActionListener(
                event -> browseForPdfFile(parent, inputField, outputField,
                        controller::buildDefaultRisoComcolorGd9630OptimizedName));

        browseOutputButton.addActionListener(event -> {
            String suggestion = controller.buildDefaultRisoComcolorGd9630OptimizedName(inputField.getText());
            browseForOutputPdf(parent, outputField, suggestion);
        });

        optimizeButton.addActionListener(event -> controller.startRisoComcolorGd9630Optimization(parent, inputField.getText(),
        ...
        gbc.gridy = 3;
        gbc.gridwidth = 3;
        JLabel infoLabel = new JLabel("Converte il PDF in PDF/A-3B con intento colore sRGB per la Riso ComColor GD9630.");
        ...
        JLabel descriptionLabel = new JLabel(
                "Converte e compatta i PDF nel formato PDF/A-3B ottimizzato per la Riso ComColor GD9630.");
