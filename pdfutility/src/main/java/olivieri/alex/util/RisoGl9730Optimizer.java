 ...
 * Riso GL9730.
 */
public class RisoGl9730Optimizer {
    ...
    public Path optimize(Path inputFile, Path outputFile, String recordId) throws IOException {
        ...
        try {
            ...
            AuditLogger.logSuccess("SERVICE_RISO_OPTIMIZE", details, outputFile);
            return outputFile;
        } catch (IOException | RuntimeException ex) {
            AuditLogger.logFailure("SERVICE_RISO_OPTIMIZE", details, outputFile, ex);
            throw ex;
        }
    }
